...
//	add_item_tag(0, item, key, value, srcid);
    ...
    dict = pmt::dict_add(dict, pmt::mp("freq_offset_short"), pmt::from_double(freq_offset));
    dict = pmt::dict_add(dict, pmt::mp("sof"), pmt::from_uint64(input_item));
    add_item_tag(0, item, pmt::string_to_symbol("wifi_start"), dict, pmt::string_to_symbol(name()));
