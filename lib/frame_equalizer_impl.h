...
private:
	...
	// [X.Z. 2019-03-26] start of modification
   	uint64_t d_sof; // start of frame in samples
   	uint64_t d_frame_start; // start of frame in samples from "sync_long" block
    	uint64_t d_reserved; // SIGNAL field reserved bit
    	uint64_t d_rate; // SIGNAL field RATE field
